			...
			<Stack>
				...
				<StackItem width="50%" lg-width="100%">
					...
					<Text as="p" margin="16px 0" font="--base" max-width="400px">
						My name is Praveen A. Maurya, born and raised in India,Completed my bachelors in IT and looking for opportunity that I wish to pursue Sofware Development field to evaluate my inherent abilities and potential. Although I have accumulated a strong foundational knowledge in this domain, I think the best way to move forward would be to get practical working experience in an established platform like Enliten IT.
					</Text>
				</StackItem>
			</Stack>
		</Section>
